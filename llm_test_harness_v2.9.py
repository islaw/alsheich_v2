...
PAGES_PER_CHUNK = 5
ROUND_NUMBER = 45 # Incremented round number
...
def get_clean_body_text_from_rich_gt(file_path):
    ...
    This version uses the CORRECTED loop structure.
    """
    ...
    try:
        ...
        for page in data.get('pages', []):
            ...
            # BUG FIX: Iterate directly through paragraphs under page, not through blocks.
            # This matches the logic of the successful diagnostic script.
...
def main():
    print(f"--- מתחיל הרצה של רתמת בדיקות v2.9, סבב מספר {ROUND_NUMBER} ---")
